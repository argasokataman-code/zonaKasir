...
const FALLBACK_PLANS: Plan[] = [
  {
    ...
    features: { product_stock: 'Product Stock', print_selling_a5: 'Print Selling A5' },
  ...
  },
  {
    ...
    features: { product_stock: 'Product Stock', product_sku: 'Product SKU', stock_opname: 'Stock Opname', voucher: 'Voucher / Discount', member: 'Member Management' },
  ...
  },
  {
    ...
    features: { product_stock: 'Product Stock', product_sku: 'Product SKU', stock_opname: 'Stock Opname', purchasing: 'Purchasing', supplier: 'Supplier Management' },
