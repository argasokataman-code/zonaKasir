    ...
    <x-table class="w-full text-sm">
      ...
      <tbody>
        ...
        <x-table-row>
          ...
          <x-table-cell class="number whitespace-nowrap">{{ $footer['total_all_discount_per_item'] }}</x-table-cell>
          <x-table-cell class="number whitespace-nowrap">{{ $footer['total_net'] }}</x-table-cell>
    ...
    <x-table class="w-full text-sm">
      ...
      <tbody>
        <x-table-row>
          ...
          <x-table-cell class="number whitespace-nowrap"><b>{{ $footer['total_all_discount_per_item'] }}</b></x-table-cell>
