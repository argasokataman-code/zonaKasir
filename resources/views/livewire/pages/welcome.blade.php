...
$mainFeatures = [
    ...
    [
        ...
        'description' => 'zonaKasir bisa diakses di android dan web',
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
    ...
    [
        'title' => 'Configurable',
        'description' => 'zonaKasir bisa di konfigurasi sesuai kebutuhan anda',
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-7 h-7">
...
<div>
      ...
      <div class="w-full px-6 mx-auto leading-10 text-center lg:px-8 max-w-7xl">
        <div class="box-border flex flex-wrap items-center justify-between -mx-4 text-indigo-900">
          ...
          <div class="relative items-center hidden px-4 mt-2 space-x-5 font-medium leading-10 md:flex md:flex-grow-0 md:flex-shrink-0 md:mt-0 md:text-right lg:flex-grow-0 lg:flex-shrink-0">
            <a href="https://wa.me/6289638706830?text=Halo%20dengan%20zonakasir%2C%20saya%20ingin%20mengatur%20jadwal%20demo%20dengan%20Anda.%20Bisakah%20kita%20membicarakannya%20lebih%20lanjut%3F"
            ...
            >Jadwalkan Demo</a>
            <a href="{{ route('auth.register') }}" class="bg-zonakasir-primary text-white md:w-auto w-full px-8 py-3 rounded-full flex items-center justify-center font-medium text-lg focus:ring-offset-2 focus:ring-2 focus:ring-zonakasir-primary">Daftar</a>
          </div>
          ...
          <div class="md:hidden">
            <div>
              <div>
                <button class="text-white hidden left-10 fixed top-20 text-2xl px-3 py-1 bg-zonakasir-primary rounded-lg"
                  x-ref="xButton"
      ...
      <div class="max-w-7xl px-10 mx-auto flex lg:flex-row flex-col py-20">
        <div class="w-full lg:w-1/2 flex lg:justify-start justify-start md:justify-center hero-title">
          <div class="lg:py-24  lg:text-left text-left md:text-center">
            ...
            <h1 class="mt-4 text-4xl tracking-tight font-extrabold text-gray-800 sm:mt-5 lg:text-left text-left md:text-center sm:text-6xl lg:mt-6 xl:text-7xl">
              <span class="block">zonaKasir</span>
              <span class="text-zonakasir-primary flex items-center justify-start lg:justify-start md:justify-center w-full">Free POS</span>
            </h1>
            <p class="mt-3 text-base text-gray-400 sm:mt-5 sm:text-xl lg:text-lg  lg:text-left text-left md:text-center xl:text-xl">
              zonaKasir merupakan aplikasi point of sale (POS) yang memudahkan pengelolaan bisnis Anda.
              <br class="xl:block hidden"> zonaKasir hadir dengan fitur yang lengkap dan mudah digunakan.
            </p>
            <div class="mt-6 sm:mt-8">
              <div class="flex md:flex-row flex-col md:space-x-5 md:space-y-0 space-y-5 lg:justify-start justify-center">
                <a href="https://github.com/zonakasir/zonakasir_flutter/releases" target="_blank" class="bg-zonakasir-primary text-white md:w-auto w-full px-8 py-4 rounded-full flex items-center justify-center font-medium text-lg focus:ring-offset-2 focus:ring-2 focus:ring-zonakasir-primary">Unduh Sekarang</a>
                <a href="#_"
        ...
        <div class="w-full lg:w-1/2 lg:flex lg:justify-center lg:max-w-none max-w-md lg:mt-0 mt-20 mx-auto relative hidden hero-phone">
          <div class="w-auto sm:w-64 absolute bottom-0 transform md:bottom-auto md:top-1/2 p-8 translate-y-16 md:translate-y-24 md:ml-16 z-10 left-0 bg-white text-gray-400 rounded-xl shadow-2xl hidden md:block">
            <div class="inline-flex absolute top-0 transform -translate-y-full bg-zonakasir-primary left-0  space-x-1 px-4 items-center h-9 w-auto rounded-full -mt-2">
            ...
            <p class="mt-2">zonaKasir memudahkan saya dalam mengelola bisnis saya, terimakasih zonaKasir.</p>
          </div>
  ...
  <section id="about" class="bg-gray-800 text-white py-32">
    <div class="lg:max-w-3xl mx-auto text-center px-5 lg:px-0">
      <p class="text-4xl font-extrabold">Tentang zonaKasir</p>
      <p class="text-lg mt-5">zonaKasir adalah aplikasi POS open-source dan juga gratis, zonakasir tersedia untuk android dan web, dengan fitur yang dimiliki zonakasir sekarang zonakasir bisa memudahkan anda dalam mencatat keuntungan anda perhari dengan mudah, zonakasir juga bisa membantu anda dalam mengelola barang yang ada di toko anda, dengan fitur yang lengkap dan mudah digunakan.</p>
    </div>
  </section>
  <section id="product-menu" class="py-10 my-10 text-gray-400">
    <div class="xl:max-w-7xl lg:max-w-4xl mx-auto">
      <p class="text-4xl font-extrabold text-center text-gray-800">Menu zonaKasir</p>
          ...
          @if ($loop->iteration % 2 == 0)
            <div class="grid grid-cols-2 lg:grid-cols-none lg:block my-10 md:my-0">
              <div class="flex gap-x-5 justify-items-center lg:mb-10 sm:my-auto ml-10 lg:ml-0">
                <div class="h-10 min-w-2 bg-zonakasir-primary rounded-lg"></div>
  ...
  <section id="main-feature" class="bg-gray-800 text-white py-32">
    <div class="md:max-w-4xl max-w-1xl mx-auto">
      <div class="mb-20 grid grid-cols-1 gap-y-5">
        <p class="text-4xl font-extrabold text-center">Fitur zonaKasir</p>
        <p class="text-lg text-center sm:mx-0 mx-5">Dengan zonakasir anda bisa mengelola toko anda dengan mudah, berikut fitur yang dimiliki oleh zonakasir.</p>
      </div>
      <div class="grid sm:grid-cols-2 lg:gap-20 gap-10 px-10">
        @foreach($mainFeatures as $feature)
        <div class="flex gap-x-4">
          <div class="bg-zonakasir-primary rounded-2xl flex justify-center items-center min-w-10 h-10">
            {!! $feature['icon'] !!}
          </div>
          <div>
  ...
  <section id="cta" class="xl:max-w-7xl lg:max-w-3xl md:px-10 mx-auto text-white">
    <div class="bg-zonakasir-primary text-center rounded-2xl my-20 p-10">
      ...
      <form action="#" class="mt-5 sm:mx-auto sm:flex sm:max-w-lg">
        <div class="min-w-0 flex-1">
          ...
          <input id="cta-email" type="email" class="block w-full rounded-md border border-transparent px-5 py-3 text-base text-gray-900 placeholder-gray-500 shadow-sm focus:border-transparent focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-zonakasir-primary" placeholder="Enter your email">
        </div>
        <div class="mt-4 sm:mt-0 sm:ml-3">
          <button type="submit" class="block w-full rounded-md border border-transparent bg-zonakasir-primary px-5 py-3 text-base font-medium text-white shadow hover:bg-zonakasir-primary focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-zonakasir-primary sm:px-10">Notify me</button>
        </div>
      </form>
    </div>
  </section>
  <section id="footer" class="bg-gray-800 text-white py-10 flex justify-center gap-x-3">
    <p>zonaKasir made with </p>
